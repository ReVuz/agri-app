...
function AddRequirement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmitStatus({ type: 'success', message: 'Requirement submitted successfully! Farmers will be notified.' });
        setFormData({
          productName: '',
          quantity: '',
          deliveryDate: '',
        ...
        setSubmitStatus({ type: 'error', message: 'Failed to submit requirement. Please try again.' });
      }
    } catch (error) {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-8">
            <h1 className="text-3xl font-bold text-white">Add Product Requirement</h1>
            <p className="mt-2 text-green-100">Submit your product requirements and we'll notify relevant farmers</p>
          </div>
